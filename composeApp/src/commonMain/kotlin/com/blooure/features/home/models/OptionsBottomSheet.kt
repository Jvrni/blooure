...
import blooure.composeapp.generated.resources.home_options_bottom_sheet_blood_pressure
import blooure.composeapp.generated.resources.home_options_bottom_sheet_users
...
enum class OptionsBottomSheet(val icon: DrawableResource, val label: StringResource, val destination: Destinations) {
    BloodPressure(
        ...
        label = Res.string.home_options_bottom_sheet_blood_pressure,
        destination = Destinations.BloodPressure
    ),
    User(
        icon = Res.drawable.ic_users,
        label = Res.string.home_options_bottom_sheet_users,
